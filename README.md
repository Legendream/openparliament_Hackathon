...
| 期間 | 問法 | 對應欄位 | 走哪張表 |
|---|---|---|---|
| ～2026.8 | 單題「請問你的職業背景是？」 | `occupation` | `value_synonyms.csv` |
| 2026.9～ | 兩題「你在哪一類組織工作或就學？」＋「你的工作內容最接近哪一類？」 | `occupation_org`、`occupation_role` | `occupation_crosswalk.csv` |
...
> 新格式則會落在「公民團體/倡議」。13 類都還在、圖表照舊，但 2026.9 前後的組成
